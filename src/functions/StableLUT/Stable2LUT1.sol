 ...
 * within Beanstalk in O(log2(n)) time complexity.
 * A lookup table was used to avoid the need for expensive price calculations on-chain.
 */
                        ...
                        if (price < 0.30624e6) {
                            if (price < 0.27702e6) {
                                if (price < 0.001083e6) {
                                    ...
                                    return PriceData(
                                        0.27702e6,
                                        0.0e18, // x (should stay the same now)
                                        9.646293093274934449e18, // y
                                        0.001083e6,
                                        0.0e18,
                                        2000.0e18,
                                        1e18
